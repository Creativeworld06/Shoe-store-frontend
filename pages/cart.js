        ...
        <Wrapper>
          ...
          <div className='flex flex-col lg:flex-row gap-12 py-10'>
            ...
            <div className='flex-[2]'>
             <div className='text-lg dont-bold'>Cart Items</div>
             {cartItems.map((item) => (
            ...
            <div className='flex-[1]'>
             ...
             {/* BUTTON START */}
             <button className='w-full py-4 rounded-full bg-black text-white text-lg font-medium transition-transform active:scale-95 mb-3 hover:opacity-75 flex item-center gap-2 justify-center' onClick={handlePayment}>
              Checkout
